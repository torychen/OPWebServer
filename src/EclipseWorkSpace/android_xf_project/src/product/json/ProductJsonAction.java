...
import product.action.ProductAction;
...
public class ProductJsonAction extends HttpServlet {
	 ...
	 *  http://192.168.1.108:8080/android_xf_project/servlet/ProductJsonAction
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (action_flag.equals("single")) {
			...
			jsonString = JsonTools.createJsonString("product", map);
			...
			jsonString = JsonTools.createJsonString("products", list);
			out.print(jsonString);
		}
