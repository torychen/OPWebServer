...
<script type="text/javascript">
	function dosubmit() {//注意是先提示用户名 然后再是姓名  然后再是密码
		...
		th.action="<%=path%>/servlet/RegisterAction" ;//提交数据到服务器端
		th.submit();
	}
</script>
	...
	<form action="" name="form1" method="post">
		<TABLE height=470 cellSpacing=0 cellPadding=0 width=580 align=center
			...
			<TBODY>
				...
				<TR>
					<TD vAlign=top align=right width=743 height=452><TABLE
