							...
							<TBODY>
									...
									<TD class=unnamed1 vAlign=top height=9><TABLE width="99%"
											...
											<TBODY>
												<TR bgColor=#ffffff height=20>
													...
													<TD width=31% noWrap><span class="foot3"><%=map.get("proname") %></span>
													</TD>
													<TD width=18% align="center" noWrap><span
														class="STYLE7" >产品价格</span>
													</TD>
													<TD width=38% noWrap><span class="STYLE7" ><%= map.get("proprice") %></span>
													</TD>
												</TR>
												<TR bgColor=#ffffff height=20>
													<TD width=13% align="center" noWrap class="STYLE7" >产品产地</TD>
													<TD width=31% noWrap colspan="3"><span class="STYLE7" ><%= map.get("proaddress") %>
													</span></TD>
												</TR>
												<TR bgColor=#ffffff height=20>
													<TD height="-1" align="center" noWrap><span
														class="STYLE7" >产品图片</span>
													</TD>
													<TD height="-1" colspan="3" valign="middle" noWrap><img
								...
								<TR>
									<TD height=27 colspan="2" align="center" vAlign=top><a
										href="javascript:dosubmit();" onMouseOut="MM_swapImgRestore()"
										onMouseOver="MM_swapImage('Image3','','<%=path%>/images/ok_2.jpg',1)"><img
											src="<%=path%>/images/ok_1.jpg" name="Image3" width="60"
											height="22" border="0">
									</a> <a href="javascript:history.back();"
										onMouseOut="MM_swapImgRestore()"
										onMouseOver="MM_swapImage('Image4','','<%=path%>/images/fh_2.jpg',1)"><img
