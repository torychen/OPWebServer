...
<script type="text/javascript">
	function dosubmit() {
        ...
        th.action="<%=path%>/servlet/ProductAction?action_flag=add";//action_add标志位   因为在添加的操作的时候 要对数据库进行update操作所以要先跳到一个处理函数中
		th.submit();
	}
</script>
											...
											<TBODY>
												<TR bgColor=#ffffff height=20>
													...
													<TD width=38% noWrap><span class="STYLE7"> <INPUT
															class=text2 maxLength=20 size=18 name="proprice"
															minLength="1"> </span>
													</TD>
												</TR>
												<TR bgColor=#ffffff height=20>
													<TD width=13% align="center" noWrap class="STYLE7">产品产地</TD>
													<TD width=31% noWrap colspan="3"><span class="STYLE7">
															<INPUT class=text2 maxLength=20 size=30 name="proaddress"
															minLength="1"> </span></TD>
												</TR>
												<TR bgColor=#ffffff height=20>
													...
													<TD height="-1" colspan="3" valign="middle" noWrap><input
