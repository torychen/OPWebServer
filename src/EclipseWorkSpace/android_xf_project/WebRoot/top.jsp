...
BODY {
	MARGIN-TOP: 0px;
	SCROLLBAR-FACE-COLOR: 04376E;
	FONT-SIZE: 12px;
	BACKGROUND: 04376E;
	SCROLLBAR-HIGHLIGHT-COLOR: 04376E;
	SCROLLBAR-SHADOW-COLOR: 04376E;
	SCROLLBAR-3DLIGHT-COLOR: 04376E;
	SCROLLBAR-ARROW-COLOR: 04376E;
	SCROLLBAR-TRACK-COLOR: 04376E;
...
<BODY>
	<div id="Layer1">
		<object classid=clsid:D27CDB6E-AE6D-11cf-96B8-444553540000
			...
			<embed src="<%=path%>/images/Stare.swf" width="402" height="70"
				quality=high
	...
	<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
		<TBODY>
			<TR>
				<TD borderColor=#0 width="100%" background="<%=path%>/images/di.jpg"
					height=108>
					<TABLE height=108 cellSpacing=0 cellPadding=0 width="100%" border=0>
						<TBODY>
							<TR>
								<TD vAlign=top height=57><img
									src="<%=path%>/images/pioneer_1.jpg" width="375" height="57">
								</TD>
										...
										<TBODY>
											<TR>
												...
												<TD vAlign=center align=middle width=100
													...
													href="<%=path%>/index.jsp" target="_parent" class=dh>退
														出</A>
												</TD>
											</TR>
										</TBODY>
